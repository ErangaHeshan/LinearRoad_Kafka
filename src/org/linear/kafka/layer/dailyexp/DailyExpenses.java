...
public class DailyExpenses
{
    ...
    private final String in_comming_topic = "dailyexp_topic";
    private final String out_going_topic = "output_topic"; //Here we assign the topic directly. No need of a config here.
    ...
    public void run(){
    	...
    	for(final KafkaStream stream : streams){
    		executor.submit(new DailyExpensesConsumer(stream, threadNumber));
    		threadNumber++;
    	}
    }
    ...
    {    	
    	DailyExpenses segStats = new DailyExpenses();
    	segStats.run();
