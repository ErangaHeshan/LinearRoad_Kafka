...
public class SegmentStatistics
{
    ...
    private final String in_comming_topic = "segstat_topic";
    private final String out_going_topic = "toll_topic"; //Here we assign the topic directly. No need of a config here.
    private final int numThreads;
    private static boolean shutdownFlag = false;;
    
    public SegmentStatistics(){
        Properties props = new Properties();       
        InputStream propertiesIS = SegmentStatistics.class.getClassLoader().getResourceAsStream(org.linear.kafka.util.Constants.CONFIG_FILENAME_SEGSTAT);
    ...
    public void run(){
    	...
    	for(final KafkaStream stream : streams){
    		executor.submit(new SegmentStatisticsConsumer(stream, threadNumber));
    		threadNumber++;
    	}
    }
